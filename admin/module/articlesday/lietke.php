<?php
$sql_lietke_articles = "SELECT * FROM articlesday ORDER BY article_id DESC";
$query_lietke_articlelist = mysqli_query($mysqli, $sql_lietke_articles);
?>
<h1 style="text-align: center">Liệt kê danh sách bài viết</h1>
<form method="POST" action="module/articlesday/process.php">
    <table style="width: 80%; text-align: center; border-collapse: collapse;" border="1">
        ...
        <tr> 
            ...
            <td>
                <a href="module/articlesday/process.php?articleid=<?php echo $row['article_id']; ?>&query=delete" onclick="return confirm('Bạn có chắc chắn muốn xóa bài viết này?');">Xoá</a> | 
                <a href="?action=quanlyarticlesday&query=edit&articleid=<?php echo $row['article_id']; ?>">Sửa</a>
            </td>
        </tr>
        <?php } ?>
    </table>
