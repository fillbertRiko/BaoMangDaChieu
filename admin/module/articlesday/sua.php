...
$sql_sua_articles = "SELECT * FROM articlesday WHERE article_id='$article_id' LIMIT 1";
$query_sua_articles = mysqli_query($mysqli, $sql_sua_articles);
?>

<h1 style="text-align: center;">Sửa Bài Viết</h1>
<form method="POST" action="module/articlesday/process.php" enctype="multipart/form-data">
