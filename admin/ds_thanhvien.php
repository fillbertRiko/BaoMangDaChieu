    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="table-responsive">
          <table cellspacing="0" cellpadding="0" class="table" style="display: block !important; overflow-x: auto !important; width: 100% !important;text-align: center;align-items:center ;" border="1">
            <thead>
              <tr>
                <th scope="row">ID</th>
