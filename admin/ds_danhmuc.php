...
<div class="content-wrapper" style="min-height: auto;">
    ...
    <div class="row">
        <div class="table-responsive">
            <table cellspacing="0" cellpadding="0" class="table" style="display: block !important; overflow-x: auto !important; width: 100% !important;" border="1">
              <thead>
                <tr>
                   <td scope="row">Id</td>
                   <td scope="row">Tên danh mục</td>
                   <td scope="row">Mã danh mục</td>
